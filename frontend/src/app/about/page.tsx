...
const values = [
  {
    ...
    icon: <Award className="text-blue-800 w-6 h-6 mr-2" />,
  ...
  },
  {
    ...
    icon: <Target className="text-blue-800 w-6 h-6 mr-2" />,
  ...
  },
  {
    ...
    icon: <Handshake className="text-blue-800 w-6 h-6 mr-2" />,
  ...
  },
  {
    ...
    icon: <Hammer className="text-blue-800 w-6 h-6 mr-2" />,
  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="px-5 md:px-6 py-10   mx-auto"
      >
        <p className="font-semibold text-16 md:text-20 max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4 mt-10 text-16 md:text-18 font-semibold">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-100 p-4 rounded-md text-center shadow-sm"
            >
              {text}
            </motion.div>
          ))}
        </div>
        <p className="font-semibold text-16 md:text-20 mt-10 max-w-4xl mx-auto text-center">
          With a strong foundation of{" "}
          <strong className="font-bold">
            integrity, excellence, and student-first values
          </strong>
          , we ensure your learning journey translates into a rewarding career.
          Whether you're a fresh graduate or looking to upskill, we’re here to
          help you{" "}
      ...
      <div className="px-5 md:px-6 py-10">
        <div className="text-center mb-6">
          <h2 className="text-24 font-bold text-center mb-4">
            Our Core Values
          </h2>
      ...
      <div className="py-16 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-6">
          <h2 className="text-24 font-bold text-center mb-4">How We Work</h2>
          <div className="w-12 h-1 bg-blue-600 rounded-full mx-auto mb-10"></div>
        </div>
      ...
      {/* Why Choose Us */}
      <div className="py-16 px-6 md:px-12 max-w-7xl mx-auto">
        <h2 className="text-24 font-bold text-center mb-4">Why Choose Us?</h2>
        <div className="w-12 h-1 bg-blue-600 rounded-full mx-auto mb-10"></div>
        ...
        >
          <h3 className="text-2xl font-semibold mb-4 text-blue-900 flex justify-center items-center gap-2">
            <TrendingUp className="text-blue-700 w-6 h-6" />
            Future-Ready, Career-Focused
          </h3>
          <p className="text-gray-700 text-md leading-relaxed">
            At <strong>Sowmya Consultancy Services</strong>, we’re more than
            just a consultancy — we’re your partner in building a meaningful
            career. Join us, and let’s shape your future together.
          </p>
        </motion.div>
      </div>
    </div>
